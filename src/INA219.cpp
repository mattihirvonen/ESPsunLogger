...
#define   CONFIG_PG_GAIN       0x3   // 320 mV - gain /8   (default)
#define   CONFIG_ADC_SAMPLES   0x3   // 1  samples 532  us (shunt, default)
//#define CONFIG_ADC_SAMPLES   0xc   // 16 samples 8.51 ms (shunt)
//#define CONFIG_MODE          0x5   // Only shunt,     continunuous
//#define CONFIG_MODE          0x6   // Only bus,       continunuous
#define   CONFIG_MODE          0x7   // Shunt and bus,  continunuous (default)
