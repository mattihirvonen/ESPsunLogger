...
##
##  [I_total, I_direct, I_diffuse, I_reflected] = ...
##      solar_intensity(lat, lon, tz, day, time, ...)

## ==================================================

function [I_total, I_direct, I_diffuse, I_reflected] = ...
    solar_intensity(lat_deg, lon_deg, tz_offset, day_of_year, time_hours, varargin)
...
% G_sc = 1367;                             % Solar constant [W/m²]
  G_sc = 1367 * irridance_calibration_fix; % Fix by MH
